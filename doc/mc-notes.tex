...
so for operator $v$ requires 1) there is no (undeleted) operator $u$
having a literal of $v$ as one of its inputs, and 2) there is no
...
\midrule
    ...
    {\tt 9} & {\tt a}  & {\tt -5 0} & {\tt 7 8 4 5 1 0} & & Assert $t_1 = \obar{p}_5 = x_1 \lor x_2 \lor x_3$ \\
            & {\tt dc}  & {\tt 1 } & {\tt 3 6 7 0} & & Delete clause $C_1$\\
