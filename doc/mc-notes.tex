...
\midrule
    ...
    {\tt 7} & {\tt a}  & {\tt -4 0} & {\tt 7 8 5 4 1 0} & & Assert $t_1 = \obar{p}_4 = x_1 \lor x_2 \lor x_3$ \\
            & {\tt dc}  & {\tt 1 } & {\tt 3 6 9 0} & & Delete clause $C_1$\\
    {\tt 8} & {\tt p}   & {\tt 5 1 -2} &              & & Declare $p_5 = x_1 \pand \obar{x}_2$ \\    
    {\tt 11} & {\tt a} & {\tt -5 0} & {\tt 12 11 2 0}  & & Assert $t_2 = \obar{p}_5 = \obar{x}_1 \lor x_2$ \\
            & {\tt dc}  & {\tt 2 } & {\tt 10 13 0} & & Delete clause $C_2$\\
    {\tt 12} & {\tt s}   & {\tt 6 4 5}   & {\tt 7 11 0}  & & Declare $s_6 = \obar{t}_1 \por \obar{t}_2$ \\
    {\tt 15} & {\tt a}  & {\tt -6 0}       & {\tt 9 13 14 0} & & Assert $t_3 = \obar{s}_7 = t_1 \land t_2$ \\
             & {\tt dc}  & {\tt 7}          & {\tt 15 17 0} & & Delete $t_1$\\
             & {\tt dc}  & {\tt 11}         & {\tt 16 17 0} & & Delete $t_2$\\
  \end{tabular}
  \end{center}  
B). Proof Clauses
  \begin{center}
