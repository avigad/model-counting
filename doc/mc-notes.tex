...
$(1-1/z)^n \geq (1-1/2n)^n >  1/2$.  Therefore, these functions can be used as part of a
...
\midrule
    ...
    {\tt 4} & {\tt ab}  & {\tt -4 -2 0} & {\tt -2 0}    & & \\
    {\tt 5} & {\tt ab}  & {\tt -4 -3 0} & {\tt -2 0}    & & \\
            & {\tt p}   & {\tt 5 -1 -4}  &             & & Declare $p_5 = \obar{x}_1 \pand \obar{p_4}$ \\
    {\tt 6} & {\tt ab}  & {\tt 5 1 4 0} & {\tt 0}    & & Defining clauses for $p_5$ \\
    {\tt 7} & {\tt ab}  & {\tt -5 -1 0} & {\tt -6 0}    & & \\
    {\tt 8} & {\tt ab}  & {\tt -5 -4 0} & {\tt -6 0}    & & \\
            & {\tt p}   & {\tt 6 1 2} &              & & Declare $p_6 = x_1 \pand x_2$ \\    
    {\tt 9} & {\tt ab}  & {\tt 6 -1 -2 0}  & {\tt 0}    & & Defining clauses for $p_6$ \\ 
    {\tt 10} & {\tt ab}  & {\tt -6 1 0}    & {\tt -9 0} & & \\
    {\tt 11} & {\tt ab}  & {\tt -6 2 0}    & {\tt -9 0} & & \\ 
            & {\tt s}   & {\tt 7 5 6}   & {\tt 7 10 0}  & & Declare $s_7 = p_5 \por p_6$ \\
    {\tt 12} & {\tt ab}  & {\tt -7 5 6 0}  & {\tt 0}    & & Defining clauses for $s_7$ \\ 
    {\tt 13} & {\tt ab}  & {\tt  7 -5 0}    & {\tt -12 0} & & \\  
    {\tt 14} & {\tt ab}  & {\tt  7 -6 0}    & {\tt -12 0} & & \\
