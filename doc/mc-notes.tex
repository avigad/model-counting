...
\centering{
  \begin{tabular}{lllll}
    ...
    $C$ & {\tt a} & $L^{*}$ {\tt 0} &  {\tt * 0} & Add RUP clause.  Inferred hint \\
     & {\tt d} & $C$             & $C^{+}$  {\tt 0} & Delete RUP clause.  Explicit hint \\
     & {\tt d} & $C$             & {\tt * 0} & Delete RUP clause.  Inferred hint \\
    \midrule
...
\midrule
    ...
    {\tt 2} & {\tt i}   & {\tt -1 2 0}  &            & & Input clause $C_2$ \\
    {\tt 3} & {\tt p}   & {\tt 4 -2 3}  &            & & Declare $p_4 = \obar{x}_2 \pand \obar{x}_3$ \\
    {\tt 6} & {\tt p}   & {\tt 5 -1 -4}  &             & & Declare $p_5 = \obar{x}_1 \pand \obar{p_4}$ \\
    {\tt 9} & {\tt p}   & {\tt 6 1 2} &              & & Declare $p_6 = x_1 \pand x_2$ \\    
    {\tt 12} & {\tt s}   & {\tt 7 5 6}   & {\tt 7 10 0}  & & Declare $s_7 = p_5 \por p_6$ \\
    {\tt 15} & {\tt a}  & {\tt 1 -4 0}    & {\tt 4 5 1 0} & & Justify $\obar{x}_1 \rightarrow \obar{p_4}$ \\
...
\midrule
    ...
    {\tt 13} &   & {\tt  7 -5 0}    &  & & \\  
    {\tt 14} &   & {\tt  7 -6 0}    &  & & \\
    {\tt 15} &   & {\tt 1 -4 0}    & {\tt 4 5 1 0} & & Justify $\obar{x}_1 \rightarrow \obar{p_4}$ \\
