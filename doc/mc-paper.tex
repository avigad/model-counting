...
generates a {\em decision} DNNF (dec-DNNF) representation (a restricted form of dec-DNNF),
and the {\em proof
...
tools handle all but the largest dec-DNNF graphs generated
...
dec-DNNF~\cite{capelli:sat:2019,capelli:aaai:2021}.  Their
modified version of \dfour{} generates additional annotations to the
compiled representation, as well as a file of clausal proof steps in the DRAT format~\cite{wetzler14_drattrim}.
These files must be processed by two different checkers.
...
implementations.  Although the authors make informal arguments
regarding the soundness of their frameworks, these do not provide
strong levels of assurance.  Indeed, as we discuss in
Appendix~\ref{app:comparison}, we uncovered a weakness in the \dfour{}
verification framework due to its invalid assumption about the
guarantees provided by \dtrim{}, the program it uses to check their
DRAT file.  Our framework is very general and is based on a small set
