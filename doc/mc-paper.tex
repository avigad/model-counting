...
was able to generated d-DNNF representations for 124 of these, and it timed out on the
...
defining clauses, and so the total number of defining clauses is equal
to the sum of the number of nonterminal nodes plus the sum of number
of children for each of these nodes.  The number of defining clauses
ranged from 304 to 2,761,457,765 with a median of 848,784.
...
one-sided proofs for 124 graphs, again with a time limit of 10,000
...
solver to search the very sparse solution space.  Our solver,
\cadical{} generally outperforms the miniSAT-based CDCL solver used by
...
our programs used for clause identifiers.  Another exited due to the
...
Figure~\ref{fig:monolithic:clauses} shows the total numbers of clauses
...
even critical to success for some benchmarks.
...
generation, proof checking, and ring evaluation in the CRAT toolchain compare to the time to
