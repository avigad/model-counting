...
$\inputformula \ifandonlyif \exists Z\,\theta$. We write $\theta_\text{foo}$ for
clausal encodings possibly using extension variables, and $\phi_\text{bar}$ for formulas that do not.
