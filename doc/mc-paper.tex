...
check whether $\phi \imply R$, i.e., that any model of $\phi$ is also
a model of $R$.  They then base other parts of their proof on that
...
their compiler and checker\footnote{Downloaded May 18, 2023 from
\url{https://github.com/crillab/d4}}.
