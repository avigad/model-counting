...
labeled by Boolean operation And or Or.  Restrictions are place on the
...
Fichte, Hecher, and Roland~\cite{fichte:sat:2021} devised the MICE
...
our tool chain to theirs as part of our experimental evluation in
...
available at \texttt{https://github.com/rebryant/crat}.}  The proof
...
numbers we term $\drational$, consisting of numbers of the form $a
\cdot 2^{b} \cdot 5^{c}$, where $a$, $b$, and $c$ are 
integers, and with $a$ implemented to have arbitary range.
