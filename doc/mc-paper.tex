...
we have identified a weakness in the their methodology due to an
invalid assumption about the guarantees provided by \dtrim{}, the
program it uses to check the DRAT file.  Moreover, this weakness is
...
As we can attest,
without engaging in the effort to formally verify the framework, there are likely to be
...
this declaration implicitly causes $k+1$ clauses to be added to the proof, using a Tseitin encoding to define extension variable $v$ as the product of its arguments.
...
this declaration implicitly causes three clauses to be added to the proof, using a Tseitin encoding to define extension variable $v$ as be the sum of its arguments.
