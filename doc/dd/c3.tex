...
\node at (1.68,4.85) {$\mathbin{\land_{\textrm{pv}}}$};
\draw [thin,fill=fillcolor,draw=neutralcolor] (1.68,1.32) circle [radius=0.53];
\node at (1.68,1.32) {$\mathbin{\land_{\textrm{pv}}}$};
...
\node at (1.32,6.62) {$\mathbin{\lor_{\textrm{pa}}}$};
\draw [thin,fill=fillcolor,draw=neutralcolor] (0.79,2.56) rectangle (1.85,3.62);
\node at (1.32,3.09) {$\mathbin{\lor_{\textrm{pa}}}$};
