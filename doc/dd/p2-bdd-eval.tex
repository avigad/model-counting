...
\draw [thin,fill=fillcolor,draw=neutralcolor] (2.21,1.54) circle [radius=0.26];
\node at (2.21,1.54) {$\sim$};
...
\draw [thin,fill=fillcolor,draw=neutralcolor] (1.76,6.53) circle [radius=0.26];
\node at (1.76,6.53) {$\sim$};
