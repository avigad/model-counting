...
\item Of the 80 benchmark problems evaluated, and comparing with both
  optimizations disabled, 55 had the number of proof clauses reduced
  by at least 10\% by using lemmas, 19 by using literal merging, and
  69 by enabling both optimizations.
\end{itemize}
...
\begin{itemize}
\item Of the 80 benchmark problems evaluated, and comparing with both
  optimizations disabled, 50 had the time reduced by at least 10\% by
  using lemmas, 27 by using literal merging, and 63 by enabling both
  optimizations.
\end{itemize}
