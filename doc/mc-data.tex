...
\begin{tikzpicture}[scale = 1.00]
  \begin{axis}[mark options={scale=0.55},grid=both, grid style={black!10}, ymode=log, ymin=100, ymax=1000000000, 
                              ...
                              xlabel={D4 runtime}, ylabel={Defining Clauses},
%                              title={D4 Defining Clause Generation}
            ]
    \input{data-formatted/time+defining}
          \end{axis}
\end{tikzpicture}
} % centering
...
\begin{tikzpicture}[scale = 1.00]
  \begin{axis}[mark options={scale=0.55},grid=both, grid style={black!10}, ymode=log, ymin=100, ymax=1000000000, 
                              ...
                              xtick={0.01, 0.1,1.0,10,100,1000}, xticklabels={0.01, 0.1, 1.0, 10, 100, 1000},
                              ytick={100,1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000}, yticklabels={$10^2$,$10^3$,$10^4$,$10^5$,$10^6$,$10^7$,$10^8$,$10^9$},
                              xlabel={D4 runtime}, ylabel={Defining Clauses},
%                              title={D4 Defining Clause Generation}
            ]
...
\centering{%
\begin{tikzpicture}[scale = 1.00]
  \begin{axis}[mark options={scale=0.55},grid=both, grid style={black!10}, ymode=log, ymin=0.01, ymax=10000,
                              x post scale=2.0, y post scale=2.2,
                              xmode=log,xmin=0.01,xmax=1000,
                              xtick={0.01, 0.1,1.0,10,100,1000}, xticklabels={0.01, 0.1, 1.0, 10, 100, 1000},
                              ytick={0.01, 0.1,1.0,10,100,1000,10000}, yticklabels={0.01, 0.1, 1.0, 10, 100, 1000,10000},
                              xlabel={D4 runtime}, ylabel={CRAT generation runtime},
%                              title={D4 Defining Clause Generation}
            ]
    ...
    \addplot[mark=none, color=lightblue] coordinates{(0.01,1.0) (100,10000)};
    \input{data-formatted/time-d4-gen}
...
\caption{Runtime for CRAT proof generation as function of D4 runtime}
\label{fig:d4:crat}
