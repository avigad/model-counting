...
\centering{%
\begin{tikzpicture}[scale = 1.00]
  \begin{axis}[mark options={scale=0.55},grid=both, grid style={black!10}, ymode=log, ymin=100, ymax=1e9, 
      legend style={at={(0.40,0.98)}},
      legend cell align={left},
                              x post scale=2.0, y post scale=2.3,
                              xmode=log,xmin=100,xmax=1e7, 
                              xtick={100,1000, 10000, 100000, 1000000, 10000000}, xticklabels={$10^2$,$10^3$,$10^4$,$10^5$,$10^6$,$10^7$},
                              ytick={100,1000, 10000, 100000, 1000000, 10000000, 100000000, 1e9}, yticklabels={$10^2$,$10^3$,$10^4$,$10^5$,$10^6$,$10^7$,$10^8$, $10^9$},
    ...
    \addplot[mark=none, color=lightblue] coordinates{(100,100) (1e8,1e8)};
    \addplot[mark=none, color=lightblue] coordinates{(100,1000) (1e8,1e9)};
    \addplot[mark=none, color=lightblue] coordinates{(100,10000) (1e7,1e9)};
