...
\centering{%
\begin{tikzpicture}[scale = 1.00]
  \begin{axis}[mark options={scale=0.55},grid=both, grid style={black!10}, ymode=log, ymin=0.01, ymax=1000,
                              x post scale=2.0, y post scale=2.2,
                              xmode=log,xmin=0.01,xmax=100,
                              xtick={0.01, 0.1,1.0,10,100}, xticklabels={0.01, 0.1, 1.0, 10, 100},
