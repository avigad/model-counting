...
\begin{enumerate}
   ...
   \item Generated POG representations from dDNNF graphs
     ...
     \item Measure complexity by number of defining clauses $D$
       ...
       \item For 122 instances, Min = 304, Median = 848,784, Mean = 93,107,937, Max = 2,761,457,765
       \end{itemize}
...
Limit set to the 92 with at most $10^7$ defining clauses.

D4 Performance (92 instances):
       \begin{itemize}
       \item Times: Min = 0.012 secs, Max = 1672.9 secs, Median = 1.85 secs
       \item Defining clauses: Min = 304, Max = 8,493,275, Median = 378,325
       \item Tree ratio: Min = 1.0, Max = 363.9, Median = 9.37, Harmonic Mean = 2.87
...
point in the traversal, it can generate a proof for a node via a
...
Our first set of experiments applies full monolithic and full structured generation to the reduced benchmark set.  We set a time limit of 1000 seconds for the proof generation.
