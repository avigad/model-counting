...
\begin{frame}
  \frametitle{Related Work \#1}
  \medskip
  
  {\bf CD4:} Verified C4 \reference{CapLagMar-2021}
  \begin{itemize}
  ...
  \end{itemize}
   \medskip
       ...
       \item No formal proof of soundness
         \begin{itemize}
         \item Found exploitable weakness
         \item RAT rule does not require model preservation
         \item Easily fixable
         \end{itemize}
...
\medskip
         ...
         \begin{itemize}
           ...
           \item Weaknesses can often be fixed by strengthening proof requirements
...
\begin{frame}
\frametitle{CPOG Proof Structure \#1}
...
\medskip
\item Most difficult part of proof generation
  \begin{itemize}
    \item Potentially exponential in POG size
    \item E.g., when $\phi_I$ is unsatisfiable
  \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{Forward Proof Generation}
           \medskip

           {\bf Direct Generation}
           \begin{itemize}
           ...
           \item Avoid exponential expansion using lemma for each shared subgraph
...
\begin{frame}
\frametitle{CPOG Proof Structure \#2}
...
\begin{itemize}
\bitem {\em Any assignment falsifying the input clause causes the POG formula to evaluate to false}
\end{itemize}
  \medskip
  
\item One RUP proof step for each clause deleted
\item Compiled form allows efficient test of clausal entailment \reference{DarMar-2002}
\end{itemize}
...
%    \item Run on high-end laptop with high-speed SSD
  ...
  \item Converted into POGs ranging from 304 to 2,761,457,765 defining clauses
  \end{itemize}
