...
\begin{frame}
  ...
  \begin{theorem}[Correctness of efficient ring evaluator]
    For any POG $P$, the ring evaluator executed on $P$ with weights $w$ returns ${\bf R}(\phi_P, w)$.
  \end{theorem}
...
\medskip
  \item Partitioned sum: ${\cal M}(\phi_1) \cap {\cal M}(\phi_2) = \emptyset$
    ...
    \bitem Disjointness of models must follow from POG defining clauses only, unsound otherwise
    \end{itemize}
\medskip
