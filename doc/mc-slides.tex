...
\begin{frame}
  ...
  % TODO(WN): Look at the Lean code to recall specifics.
\end{frame}
...
\begin{frame}
  \frametitle{CPOG Example: Asserted Clauses}
...
\begin{minipage}{0.58\textwidth}
  ...
  \begin{itemize}
    \item All assertions must give justifying RUP sequence
    \item Finishes with unit clause asserting root literal
  \end{itemize}
...
\begin{frame}
  \frametitle{CPOG Example: Clause Deletions}
...
\end{itemize}
\item Only POG declaration $\theta_P$ remains at end
  \begin{itemize}
