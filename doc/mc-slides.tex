...
\begin{center}
  ...
  \medskip
    ...
    \begin{tabular}{llllll}
      \makebox[2mm][l]{\rtext{$C$}} & \makebox[17mm][l]{Clause ID} & 
      \makebox[2mm][l]{\btext{$L$}} & \makebox[13mm][l]{Literal} &
      \makebox[2mm][l]{\gtext{$V$}} & \makebox[13mm][l]{Variable} \\
    \end{tabular}
\end{center}
...
\begin{frame}
\frametitle{Forward Proof Generation:Direct Method}
\vskip -1.0em
\begin{eqnarray*}
  \phi_I & \implies & \theta_P
\end{eqnarray*}
...
\begin{frame}
\frametitle{Forward Proof Generation:Structured Method}
\vskip -1.0em
\begin{eqnarray*}
  \phi_I & \implies & \theta_P
\end{eqnarray*}
